  ...
  <div class="top-bar" :class="{ topBarNight: model == 1 }">
    ...
    <div class="menu">
      <LyButton
        size="small"
        :nom="
          id == 1 ? (model == 0 ? 'cscondary' : 'csecondaryNight') : 'cprimary'
        "
        class="menu-message"
        @click="changeWall(0)"
        >留言墙</LyButton
      ><LyButton
        size="small"
        :nom="
          id == 0 ? (model == 0 ? 'cscondary' : 'csecondaryNight') : 'cprimary'
        "
        class="menu-photo"
        @click="changeWall(1)"
        >照片墙</LyButton
    ...
    <div class="user">
      <div class="user-head" @click="changeModel">
        <img
          src="../../src/assets/images/taiyang.png"
          class="img"
          v-if="model == 0"
        />
        <img
          src="../../src/assets/images/yueliang.png"
          class="img1"
          v-if="model == 1"
        />
      </div>
